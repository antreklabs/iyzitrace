...
interface OperationsMsChartsProps {
  series: [];
  colors?: string[];
  chartId?: string;
}
const OperationsMsCharts: React.FC<OperationsMsChartsProps> = ({ series, colors, chartId = 'default' }) => {
  ...
  const options = {
    ...
    colors: colors ?? [
      '#1E90FF', '#FF4E50', '#32CD32', '#FFD700', '#FF69B4', 
      '#00CED1', '#FF8C00', '#9370DB', '#20B2AA', '#FF1493',
      '#00FA9A', '#FF6347', '#4169E1', '#DC143C', '#32CD32',
      '#FF4500', '#8A2BE2', '#00BFFF', '#FF7F50', '#6A5ACD'
    ],
    stroke: {
      width: 3,
      curve: 'smooth',
...
export default OperationsMsCharts;
