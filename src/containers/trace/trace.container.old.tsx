...
const TraceContainerOld: React.FC = () => {
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            <div style={{ display: 'inline-flex', gap: 16 }}>
              {statsData.map((stat) => (
                <div key={stat.title}>
                  <TraceMetricsCard title={stat.title} value={stat.value} unit={stat.unit} chartData={stat.chartData} />
                </div>
              ))}
            </div>
          </div>
...
export default TraceContainerOld;