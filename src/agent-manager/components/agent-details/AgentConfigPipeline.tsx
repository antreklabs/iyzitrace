...
import { type Agent } from "@agent-manager/api/agents";
import { sendConfigToAgent } from "@agent-manager/api/agents";
import { fetchAgentComponentMetrics } from "@agent-manager/api/collector-metrics";
import { getConfigs } from "@agent-manager/api/configs";
import { CollectorPipelineView } from "@agent-manager/components/collector-pipeline/CollectorPipelineView";
import { ConfigYamlEditorWithMetrics } from "@agent-manager/components/configs/ConfigYamlEditorWithMetrics";
...
import { type TimeRange, DEFAULT_TIME_RANGE } from "@agent-manager/types/timeRange";
