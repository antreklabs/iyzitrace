...
import { getAgents, deleteAgent } from "@agent-manager/api/agents";
import { getGroups } from "@agent-manager/api/groups";
...
import { Switch } from "@agent-manager/components/ui/switch";
...
import type { Agent } from "@agent-manager/types/agent";
...
export default function AgentsPage() {
  ...
  const filteredAndSortedAgents = useMemo(() => {
    ...
    return filtered;
  }, [agentsData, showActiveOnly, sortOrder, searchQuery]);
